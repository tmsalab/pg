...
#ifndef PG_INVERT_Y_BONES_H
#define PG_INVERT_Y_BONES_H

const double tol    = 1e-8;
const double IYPI = 3.141592653589793238462643383279502884197;

inline double   y_eval(double v);
inline void   ydy_eval(double v, double* yp, double* dyp);

inline double   f_eval(double v, void* params);
inline double  df_eval(double v, void* params);
inline void   fdf_eval(double v, void* params, double* fp, double* dfp);

inline double v_eval(double y, double tol=1e-9, int max_iter=1000);
